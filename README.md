...
# Sainsburys Bank - Web - Lesson 4 - Accessibility Example

This repository shows an example of the Axe accessibility engine.
...
```sh
git clone https://github.com/Manual-To-Automation-Sainsburys-Bank/Web-Lesson-4-Accessibility.git
```

Move into the directory:

```sh
cd Web-Lesson-4-Accessibility
```
